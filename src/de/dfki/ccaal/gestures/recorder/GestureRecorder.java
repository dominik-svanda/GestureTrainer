...
import de.dfki.android.gestureTrainer.GestureTrainer;
...
public class GestureRecorder implements SensorEventListener {
	...
	public void onSensorChanged(SensorEvent sensorEvent) {
		...
		case MOTION_DETECTION:
			if (isRecording && GestureTrainer.pressedTrainOK.isPressed()) {
			...
			if (!GestureTrainer.pressedTrainOK.isPressed() && (stepsSinceNoMovement != 0)) {
